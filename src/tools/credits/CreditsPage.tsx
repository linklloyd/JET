  ...
  return (
    <div className="space-y-8 max-w-2xl">
      ...
      <section className="space-y-3">
        ...
        <a
          href="https://github.com/linklloyd/JET"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-zinc-900 text-white text-sm font-medium rounded-lg hover:bg-zinc-800 transition-colors"
        >
